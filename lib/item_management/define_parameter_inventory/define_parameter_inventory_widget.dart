...
import 'define_parameter_inventory_model.dart';
export 'define_parameter_inventory_model.dart';

class DefineParameterInventoryWidget extends StatefulWidget {
  const DefineParameterInventoryWidget({
    super.key,
  ...
  @override
  State<DefineParameterInventoryWidget> createState() =>
      _DefineParameterInventoryWidgetState();
}

class _DefineParameterInventoryWidgetState
    extends State<DefineParameterInventoryWidget> {
  late DefineParameterInventoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DefineParameterInventoryModel());
