...
class _EditItemWidgetState extends State<EditItemWidget> {
  ...
  void initState() {
    ...
    _model.emailidTextController1 ??=
        TextEditingController(text: widget.item?.measurementUnit);
    ...
    _model.emailidTextController3 ??=
        TextEditingController(text: widget.item?.vendorName);
    _model.emailidFocusNode3 ??= FocusNode();

    _model.emailidTextController4 ??=
        TextEditingController(text: widget.item?.remarks);
    _model.emailidFocusNode4 ??= FocusNode();
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    keyboardType: TextInputType
                                                        .emailAddress,
                                                    validator: _model
                                                        .emailidTextController4Validator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                    ...
                                    child: Align(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await ItemManagementTable().update(
                                            data: {
                                              'itemCode': _model
