...
class CreateUserCopyWidget extends StatefulWidget {
  const CreateUserCopyWidget({
    super.key,
    required this.authenticatedUser,
    required this.authenticatedComapny,
    required this.authenticatedCompanyDropdown,
  });

  final UserManagementRow? authenticatedUser;
  final CompanyManagementRow? authenticatedComapny;
  final List<DropdownManagementRow>? authenticatedCompanyDropdown;

  @override
  State<CreateUserCopyWidget> createState() => _CreateUserCopyWidgetState();
}

class _CreateUserCopyWidgetState extends State<CreateUserCopyWidget> {
  late CreateUserCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateUserCopyModel());
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return FlutterFlowDataTable<
                                                ...
                                                dataRowBuilder:
                                                    (assignedModulesItem,
                                                            assignedModulesIndex,
                                                            selected,
                                                            onSelectChanged) =>
                                                        DataRow(
                                                  color:
                                                      MaterialStateProperty.all(
                                                    assignedModulesIndex % 2 ==
                                                            0
                                                        ? FlutterFlowTheme.of(
                                                                context)
                                                            .secondaryBackground
                                      ...
                                      child: Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if ((_model.user?.succeeded ??
                                                true)) {
                                              _model.userAuthentication =
