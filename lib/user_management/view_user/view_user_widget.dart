...
class _ViewUserWidgetState extends State<ViewUserWidget> {
  ...
  void initState() {
    ...
    _model.fullnameTextController ??=
        TextEditingController(text: widget.vieUser?.fullName);
    _model.fullnameFocusNode ??= FocusNode();

    _model.primarymobilenoTextController ??=
        TextEditingController(text: widget.vieUser?.phone);
    _model.primarymobilenoFocusNode ??= FocusNode();

    _model.emailidTextController ??=
        TextEditingController(text: widget.vieUser?.email);
