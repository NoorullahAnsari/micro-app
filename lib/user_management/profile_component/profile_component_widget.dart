...
import '/user_management/edit_user_copy2/edit_user_copy2_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'l7avya3m' /* Below are your profile details */,
                      ),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: AutoSizeText(
                                        widget.authenticatedUser?.phone !=
                                                    null &&
                                ...
                                await showDialog(
                                  ...
                                  builder: (dialogContext) {
                                    return Dialog(
                                      ...
                                      child: EditUserCopy2Widget(
                                        userId: widget.authenticatedUser!,
                                        authenticatedUser:
                                            widget.authenticatedUser!,
                                        authenticatedCompany:
                                            widget.authenticatedCompany!,
                                        authenticatedCompanyDropdown: widget
