...
import 'edit_lead_model.dart';
export 'edit_lead_model.dart';

class EditLeadWidget extends StatefulWidget {
  const EditLeadWidget({
    super.key,
  ...
  @override
  State<EditLeadWidget> createState() => _EditLeadWidgetState();
}

class _EditLeadWidgetState extends State<EditLeadWidget> {
  late EditLeadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditLeadModel());
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '1ewb1qfr' /* Table Contact Number for Lead: */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                            ...
                                                            label:
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'obpgmriu' /* Contact Person Mobile No. */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelLarge
                                                        ...
                                                        FlutterFlowDropDown<
                                                          ...
                                                          hintText:
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            'dkkr7ip6' /* Select Lead Status... */,
                                                          ),
                                                          searchHintText:
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                            'g4jtfydm' /* Search for an item... */,
                                                          ),
                                                          icon: Icon(
                                                            Icons
                                                      ...
                                                      FlutterFlowDropDown<
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'cbafl3es' /* Please select... */,
                                                        ),
                                                        searchHintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '2gcwyjoi' /* Search for an item... */,
                                                        ),
                                                        icon: Icon(
                                                          Icons
                                                              .keyboard_arrow_down_rounded,
                                                    ...
                                                    children: [
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'vt5qu2uu' /* Currently Assigned To */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      FlutterFlowDropDown<
                                                        ...
                                                        options: [
                                                          ...
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'acywooo1' /* Nishant Desai */,
                                                          ),
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'kqt1dtiz' /* Akshay Patil */,
                                                          )
                                                        ],
                                                        onChanged: (val) =>
                                                            setState(() => _model
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'ojckeiyr' /* Select Lead Status... */,
                                                        ),
                                                        searchHintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'dt846h1j' /* Search for an item... */,
                                                        ),
                                                        icon: Icon(
                                                          Icons
                                                              .keyboard_arrow_down_rounded,
                                            ...
                                            TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'atobih8d' /* Remarks from Sales Person */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
