...
class HistorCardLeadsWidget extends StatefulWidget {
  const HistorCardLeadsWidget({
    super.key,
  ...
  @override
  State<HistorCardLeadsWidget> createState() => _HistorCardLeadsWidgetState();
}

class _HistorCardLeadsWidgetState extends State<HistorCardLeadsWidget> {
  late HistorCardLeadsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistorCardLeadsModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserManagementRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserManagementRow> historCardLeadsUserManagementRowList =
            snapshot.data!;
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'e425ue1e' /* Please Enter Correct Quantity */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'phlheyld' /*  Enter Correct Details */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'z0xm561y' /* Enter Correct Quantity */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
