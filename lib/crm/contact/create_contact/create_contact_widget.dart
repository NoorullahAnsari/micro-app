                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Flexible(
                                            child: TextFormField(
                                              controller: _model
                                                  .profileidTextController,
                                              focusNode:
                                                  _model.profileidFocusNode,
                                              autofocus: false,
                                              readOnly: true,
                                              obscureText: false,
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .createdOnTextController,
                                                focusNode:
                                                    _model.createdOnFocusNode,
                                                autofocus: false,
                                                readOnly: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'ls3ifa4v' /* General Follow Up Frequency : */,
                                                ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  controller: _model
                                                          .profilecategoryValueController ??=
                                                      FormFieldController<
                                                          String>(
                                                    _model.profilecategoryValue ??=
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'ybtcmd6j' /* B2B */,
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '3yztnjzt' /* Select Category... */,
                                                  ),
                                                  searchHintText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    'i20v13yj' /* Search for an item... */,
                                                  ),
                                                  icon: Icon(
                                                    Icons
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'jjn7raf3' /* Select Country */,
                                                  ),
                                                  searchHintText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    '4vsql1cv' /* Search for an item... */,
                                                  ),
                                                  icon: Icon(
                                                    Icons
                                                        .keyboard_arrow_down_rounded,
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  controller: _model
                                                    ...
                                                    _model.stateValue ??=
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'r6p12xip' /* Maharashtra */,
                                                    ),
                                                  ),
                                                  options: [
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'v7apatyl' /* Maharashtra */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'lxx81487' /* Rajasthan */,
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '5km9tc3v' /* Select State */,
                                                  ),
                                                  searchHintText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    '7utoujng' /* Search for an item... */,
                                                  ),
                                                  icon: Icon(
                                                    Icons
                                                        .keyboard_arrow_down_rounded,
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'iah7ebis' /* Select City */,
                                                  ),
                                                  searchHintText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    'o48hil38' /* Search for an item... */,
                                                  ),
                                                  icon: Icon(
                                                    Icons
                                                        .keyboard_arrow_down_rounded,
