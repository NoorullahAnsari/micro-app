                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'de4jp49w' /* General Follow Up Frequency : */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowDropDown<String>(
                                        ...
                                        options: [
                                          ...
                                          FFLocalizations.of(context).getText(
                                            '4ph90pji' /* Family & Friends */,
                                          )
                                        ],
                                        onChanged: (val) => setState(() =>
                                            _model.profilecategoryValue = val),
                                        width: 300.0,
                                        height: 50.0,
                                        searchHintTextStyle:
                                            FlutterFlowTheme.of(context)
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'w2bz3puf' /* Select Category... */,
                                        ),
                                        searchHintText:
                                            FFLocalizations.of(context).getText(
                                          '9it770tp' /* Search for an item... */,
                                        ),
                                        icon: Icon(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowDropDown<String>(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'plcsv049' /* Select Country */,
                                        ),
                                        searchHintText:
                                            FFLocalizations.of(context).getText(
                                          'z2doauqn' /* Search for an item... */,
                                        ),
                                        icon: Icon(
                                          Icons.keyboard_arrow_down_rounded,
                                          color: FlutterFlowTheme.of(context)
                                      ...
                                      FlutterFlowDropDown<String>(
                                        controller:
                                          ...
                                          _model.stateValue ??=
                                              FFLocalizations.of(context)
                                                  .getText(
                                            '48qtow84' /* Maharashtra */,
                                          ),
                                        ),
                                        options: [
                                          FFLocalizations.of(context).getText(
                                            'cz66letb' /* Maharashtra */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'nohufeh9' /* Rajasthan */,
                                          ),
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'f9i9fm39' /* Select State */,
                                        ),
                                        searchHintText:
                                            FFLocalizations.of(context).getText(
                                          'nx4cd17u' /* Search for an item... */,
                                        ),
                                        icon: Icon(
                                          Icons.keyboard_arrow_down_rounded,
                                          color: FlutterFlowTheme.of(context)
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowDropDown<String>(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'd7bts6kb' /* Select City */,
                                        ),
                                        searchHintText:
                                            FFLocalizations.of(context).getText(
                                          'srnt8kqw' /* Search for an item... */,
                                        ),
                                        icon: Icon(
                                          Icons.keyboard_arrow_down_rounded,
                                          color: FlutterFlowTheme.of(context)
