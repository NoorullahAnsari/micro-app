                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '5zr6q061' /* General Follow Up Frequency : */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowDropDown<String>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'u923kt11' /* Select Category... */,
                                              ),
                                              searchHintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'i756dgwn' /* Search for an item... */,
                                              ),
                                              icon: Icon(
                                                Icons
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowDropDown<String>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '2572r7k2' /* Select Country */,
                                              ),
                                              searchHintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '0goj2lwe' /* Search for an item... */,
                                              ),
                                              icon: Icon(
                                                Icons
                                                    .keyboard_arrow_down_rounded,
                                            ...
                                            FlutterFlowDropDown<String>(
                                              controller: _model
                                                ...
                                                _model.stateValue ??=
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'nrvgkk0a' /* Maharashtra */,
                                                ),
                                              ),
                                              options: [
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  's93hm3pk' /* Maharashtra */,
                                                ),
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'xi3iupes' /* Rajasthan */,
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'aprpah95' /* Select State */,
                                              ),
                                              searchHintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '15pqpq6a' /* Search for an item... */,
                                              ),
                                              icon: Icon(
                                                Icons
                                                    .keyboard_arrow_down_rounded,
                                          ...
                                          children: [
                                            ...
                                            FlutterFlowDropDown<String>(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'zik9wsyt' /* Select City */,
                                              ),
                                              searchHintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '32pl2ppd' /* Search for an item... */,
                                              ),
                                              icon: Icon(
                                                Icons
                                                    .keyboard_arrow_down_rounded,
