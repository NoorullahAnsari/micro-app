...
import 'outward_material_outward_type_model.dart';
export 'outward_material_outward_type_model.dart';

class OutwardMaterialOutwardTypeWidget extends StatefulWidget {
  const OutwardMaterialOutwardTypeWidget({
    super.key,
  ...
  @override
  State<OutwardMaterialOutwardTypeWidget> createState() =>
      _OutwardMaterialOutwardTypeWidgetState();
}

class _OutwardMaterialOutwardTypeWidgetState
    extends State<OutwardMaterialOutwardTypeWidget> {
  late OutwardMaterialOutwardTypeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OutwardMaterialOutwardTypeModel());
