...
import 'inward_material_inward_location_model.dart';
export 'inward_material_inward_location_model.dart';

class InwardMaterialInwardLocationWidget extends StatefulWidget {
  const InwardMaterialInwardLocationWidget({
    super.key,
  ...
  @override
  State<InwardMaterialInwardLocationWidget> createState() =>
      _InwardMaterialInwardLocationWidgetState();
}

class _InwardMaterialInwardLocationWidgetState
    extends State<InwardMaterialInwardLocationWidget> {
  late InwardMaterialInwardLocationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InwardMaterialInwardLocationModel());
