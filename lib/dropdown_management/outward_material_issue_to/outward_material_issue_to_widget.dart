...
import 'outward_material_issue_to_model.dart';
export 'outward_material_issue_to_model.dart';

class OutwardMaterialIssueToWidget extends StatefulWidget {
  const OutwardMaterialIssueToWidget({
    super.key,
  ...
  @override
  State<OutwardMaterialIssueToWidget> createState() =>
      _OutwardMaterialIssueToWidgetState();
}

class _OutwardMaterialIssueToWidgetState
    extends State<OutwardMaterialIssueToWidget> {
  late OutwardMaterialIssueToModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OutwardMaterialIssueToModel());
