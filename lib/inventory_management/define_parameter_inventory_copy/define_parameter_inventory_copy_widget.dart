...
class DefineParameterInventoryCopyWidget extends StatefulWidget {
  const DefineParameterInventoryCopyWidget({
    super.key,
  ...
  @override
  State<DefineParameterInventoryCopyWidget> createState() =>
      _DefineParameterInventoryCopyWidgetState();
}

class _DefineParameterInventoryCopyWidgetState
    extends State<DefineParameterInventoryCopyWidget> {
  late DefineParameterInventoryCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DefineParameterInventoryCopyModel());
