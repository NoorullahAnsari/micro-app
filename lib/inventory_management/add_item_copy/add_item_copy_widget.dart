...
class AddItemCopyWidget extends StatefulWidget {
  const AddItemCopyWidget({
    super.key,
  ...
  @override
  State<AddItemCopyWidget> createState() => _AddItemCopyWidgetState();
}

class _AddItemCopyWidgetState extends State<AddItemCopyWidget> {
  late AddItemCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddItemCopyModel());
