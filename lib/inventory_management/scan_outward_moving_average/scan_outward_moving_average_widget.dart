...
import 'scan_outward_moving_average_model.dart';
export 'scan_outward_moving_average_model.dart';

class ScanOutwardMovingAverageWidget extends StatefulWidget {
  const ScanOutwardMovingAverageWidget({
    super.key,
  ...
  @override
  State<ScanOutwardMovingAverageWidget> createState() =>
      _ScanOutwardMovingAverageWidgetState();
}

class _ScanOutwardMovingAverageWidgetState
    extends State<ScanOutwardMovingAverageWidget> {
  late ScanOutwardMovingAverageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScanOutwardMovingAverageModel());

    _model.textController1 ??= TextEditingController(text: widget.lotNo);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.receivedTextController ??=
        TextEditingController(text: widget.requireQuantity);
    _model.receivedFocusNode ??= FocusNode();

    _model.requiredTextController ??=
        TextEditingController(text: widget.requireQuantity);
    ...
    _model.textController6 ??= TextEditingController(text: widget.remark);
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      functions.fetchValueFromJson(
                                                                          containerItemManagementRowList
                                                                              .where((e) => e.itemName == widget.itemName)
                                                                              .toList()
                                                                              .first
                                                                              .parameters,
                                                                          parametersItem),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              value: () {
                                                                                if (valuesItem == 'HR Coil No') {
                                                                                  return widget.coilNumber;
                                                                                } else if (valuesItem == 'Finish') {
                                                                                  return widget.finish;
                                                                                } else if (valuesItem == 'Edge') {
                                                                                  return widget.edge;
                                                                                } else if (valuesItem == 'No of Pcs') {
                                                                                  return widget.pcs;
                                                                                } else if (valuesItem == 'Grade') {
                                                                                  return widget.grade;
                                                                                } else {
                                                                                  return '';
                                                                                }
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      controller:
                                                                        ...
                                                                        text: containerItemManagementRowList
                                                                            .where((e) =>
                                                                                e.itemName ==
                                                                                widget.itemName)
                                                                            .toList()
