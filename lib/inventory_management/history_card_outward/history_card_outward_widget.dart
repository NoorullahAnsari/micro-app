...
class HistoryCardOutwardWidget extends StatefulWidget {
  const HistoryCardOutwardWidget({
    super.key,
  ...
  @override
  State<HistoryCardOutwardWidget> createState() =>
      _HistoryCardOutwardWidgetState();
}

class _HistoryCardOutwardWidgetState extends State<HistoryCardOutwardWidget> {
  late HistoryCardOutwardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoryCardOutwardModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserManagementRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserManagementRow> historyCardOutwardUserManagementRowList =
            snapshot.data!;
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'mxd0ndj3' /* Please Enter Correct Quantity */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          'up38tmao' /*  Enter Correct Details */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        FFLocalizations.of(context)
                                                                            .getText(
                                                                          '697t9292' /* Enter Correct Quantity */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
